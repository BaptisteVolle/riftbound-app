...
function renderCandidates(candidates) {
  ...
  return `import { CardmarketOverride } from './cardmarket.types';

// Generated by scripts/generate-cardmarket-candidates.mjs.
// Generated from RiftCodex metadata. Manual corrections belong in
// cardmarket-overrides.data.ts so this file can be regenerated safely.
export const cardmarketCandidates: CardmarketOverride[] = [
${rows}
];
`;
}
